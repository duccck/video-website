...
if(isset($_SESSION['role'])) {
    if ($_SESSION['role'] != 'admini') {
        ...
        if(history.length > 0) history.go(-1); else window.location="index.php";</Script>';
    }
}
else {
    echo '<script>alert(\'请使用管理员账号登录。\');
...
<!--    </a>-->
    <table id="menu">
        <tr>
            ...
            <td>
                <a href="cover.php">
                    <strong><span style="margin: 0px 20px 0px 0px; color: #29A4F8;">封面上传</span></strong>
                </a>
            </td>
            <td>
                <a href="editor.php">
    ...
    <div class="login">
        <div>
            ...
            <div style="margin: 10px;">
                ...
                <span style="font-size: 32px; color: #29A4F8">视频封面</span>
            </div>
            <form action="process/cover_deal.php" method="post" enctype="multipart/form-data">
                <div>
                ...
                <br/>
                <br/>
                <div style="margin-top: 15px; height: 131px; background: #D4DEDF; border-radius: 0px 0px 10px 10px;">
                    <input style="margin-top: 50px;" type="file" name="file"/>
                    <input style="margin-top: 50px; height: 26px;" type="submit" value="上传"/>
                </div>
