...
<form action="process/video_delete.php" method="post">
    <div id="table" align="center">
        ...
        <table style="padding: 3px 0px;">
            <tr>
                <td>
                    <a id="a" href="manager.php"><span style="margin: 0px 40px 0px 0px;">所有</span></a>
                </td>
                <td>
                    <?php
                    if ($tag=='tv') {
                        echo '
                            ...
                            <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">剧集</span></strong>
                            </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='movie') {
                        echo '
                            ...
                            <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">电影</span></strong>
                            </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='mv') {
                        echo '
                            ...
                            <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">音乐</span></strong>
                            </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='cartoon') {
                        echo '
                            ...
                            <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">动画</span></strong>
                            </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='science') {
                        echo '
                            ...
                            <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">科技</span></strong>
                            </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='game') {
                        echo '
                            ...
                            <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">游戏</span></strong>
                            </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='tvx') {
                        ...
                        <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">综艺</span></strong>
                        </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='moviex') {
                        ...
                        <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">新闻</span></strong>
                        </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='mvx') {
                        ...
                        <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">娱乐</span></strong>
                        </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='cartoonx') {
                        ...
                        <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">财经</span></strong>
                        </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='sciencex') {
                        ...
                        <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">体育</span></strong>
                        </a>
                        ';
                    }
                    else {
                ...
                <td>
                    ...
                    if ($tag=='gamex') {
                        ...
                        <strong><span style="margin: 0px 40px 0px 0px; color: #29A4F8;">少儿</span></strong>
                        </a>
                        ';
                    }
                    else {
...
//            $i;
            $selectx = "SELECT title FROM cover WHERE (tag='$tagx') ORDER BY id DESC";
