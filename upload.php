...
<!--    </a>-->
    <table id="menu">
        <tr>
            ...
            <td>
                <a href="upload.php">
                    <strong><span style="margin: 0px 20px 0px 0px; color: #29A4F8;">视频上传</span></strong>
                </a>
            </td>
            <td>
                <a href="cover.php">
...
<div class="father">
    <div class="login">
        <div>
            <br/>
            <form action="process/uploaddeal.php" method="post" enctype="multipart/form-data">
                <div style="margin: 10px;">
                    <!--                    <img src="img/video.png">-->
                    <span style="font-size: 32px; color: #29A4F8">视频上传</span>
                </div>
                <div>
